...
Vi har valgt at bygge applikationen op webbaseret i html, css og javascript. Hele implementeringen af Google maps foregår med javascript, hvor vi så bagefter vil lave en android webview app så vi kan tilføje applikationen på google play store. vi mangler at implementere alt andet end kortet samt indholdet.
...
Det første udkast til systemet blev skrevet med java/google developer tools som vi havde planlagt det. Men efter mange timers forsøg, måtte vi erkende det måske var en uoverkommelig opgave. Vi er derfor gået over til at lave appen webbaseret og bruge værktøjer som javascript, css og html. Derfor har vi kun 1.udgave klar, da vi ikke er nået længere på nuværende tidspunkt. 
...
\begin{figure}[h]
\includegraphics[scale = 0.5]{commitlog}
\end{figure}

\newpage
\subsection*{HTML og javascript}
\begin{lstlisting}
<!DOCTYPE html>
<html>
  <head>
